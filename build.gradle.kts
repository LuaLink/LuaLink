...
modrinth {
    ...
    gameVersions.addAll("1.21.4", "1.21.5", "1.21.6", "1.21.7", "1.21.8", "1.21.9", "1.21.10", "1.21.11")
    ...
    publications.register("plugin") {
        ...
        platforms {
            register(Platforms.PAPER) {
                ...
                platformVersions.set(listOf("1.21.4", "1.21.5", "1.21.6", "1.21.7", "1.21.8", "1.21.9", "1.21.10", "1.21.11"))
            }
        }
    }
}
